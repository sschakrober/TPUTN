...
using IELChak.Models.AccountViewModels;
using IELChak.Services;
                ...
                if (result.Succeeded)
                {
                    ...
                    if(!xRol)
                    {
                        ...
                        if(res.Succeeded)
                        {
                            ...
                            _logger.LogInformation("user create a new account with password");
                        }
                    }
                    ...
                    xRol = await _roleManager.RoleExistsAsync("Usuarios");
                    if(!xRol)
                    {
